...
In practice, limits on possible values and quantization make the effective dimensions finite, but nonetheless too large for direct analysis.% of the regions in which realistic flow behaviors can be found.
